...
const Login = () => {
  ...
  return (
    // মেইন কন্টেইনার (Navbar এর নিচে প্যাডিং বন্ধ করার জন্য pt-0 দেওয়া যেতে পারে যদি Navbar transparent হয়)
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-[#f8faff] relative overflow-hidden">
      
      {/* --- BACKGROUND ANIMATION (Soft Mesh Gradient) --- */}
      {/* বাম পাশের বেগুনি আভা */}
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="group space-y-1">
             <div className="flex justify-between items-center ml-1">
              ...
              <Link to="/forgot-password" className="text-xs font-bold text-[#5e17eb] hover:underline">
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
